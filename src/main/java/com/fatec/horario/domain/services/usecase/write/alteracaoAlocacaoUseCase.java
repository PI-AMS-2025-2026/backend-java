...
public class AlteracaoAlocacaoUseCase {
        ...
        public void executarCasoUso(
                ...
                registrarSeAlterou("disciplina", alocacaoAtual.getDisciplina().getId(), novaDisciplina.getId(),
                                alocacaoAtual,
                                usuarioAlteracao, justificativa);
                ...
                registrarSeAlterou("usuario", alocacaoAtual.getUsuario().getId(), novoUsuario.getId(), alocacaoAtual,
                                usuarioAlteracao, justificativa);
                registrarSeAlterou("diaSemana", alocacaoAtual.getDiaSemana().getId(), novoDiaSemana.getId(),
                                alocacaoAtual,
                                usuarioAlteracao, justificativa);
